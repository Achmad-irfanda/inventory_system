...
class AppsRegisterForm extends StatefulWidget {
  const AppsRegisterForm({super.key});

  @override
  State<AppsRegisterForm> createState() => _AppsRegisterFormState();
}

class _AppsRegisterFormState extends State<AppsRegisterForm> {
  @override
